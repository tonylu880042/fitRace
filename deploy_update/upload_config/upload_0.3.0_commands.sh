...
aws s3 cp deploy_update/releases/0.3.0/fitrace-hub-0.3.0.tar.zst "s3://${BUCKET}/releases/0.3.0/fitrace-hub-0.3.0.tar.zst"
aws s3 cp deploy_update/releases/0.3.0/fitrace-hub-0.3.0.tar.zst.sha256 "s3://${BUCKET}/releases/0.3.0/fitrace-hub-0.3.0.tar.zst.sha256"
aws s3 cp deploy_update/releases/0.3.0/fitrace-edge-0.3.0.tar.zst "s3://${BUCKET}/releases/0.3.0/fitrace-edge-0.3.0.tar.zst"
aws s3 cp deploy_update/releases/0.3.0/fitrace-edge-0.3.0.tar.zst.sha256 "s3://${BUCKET}/releases/0.3.0/fitrace-edge-0.3.0.tar.zst.sha256"
aws s3 cp deploy_update/releases/0.3.0/release-notes.md "s3://${BUCKET}/releases/0.3.0/release-notes.md"
